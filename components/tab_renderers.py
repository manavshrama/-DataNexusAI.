...
def render_insights_tab():
    st.header("🌌 AI Insights: Deep-dive analysis generated by the Nexus AI Core.")
        ...
        for insight in insights:
            ...
            <div style="background-color: rgba(17, 37, 62, 0.8); border: 1px solid rgba(115, 118, 135, 0.15); border-radius: 12px; padding: 20px; margin-bottom: 16px;">
                <div style="display: flex; gap: 16px;">
                    <div style="width: 48px; height: 48px; border-radius: 12px; background-color: {"rgba(220, 38, 38, 0.1)" if insight["severity"] == "high" else "rgba(234, 88, 12, 0.1)" if insight["severity"] == "medium" else "rgba(59, 130, 246, 0.1)"}; display: flex; align-items: center; justify-content: center; color: {"#dc2626" if insight["severity"] == "high" else "#ea580c" if insight["severity"] == "medium" else "#3b82f6"};">
                    ...
                    <div style="flex: 1;">
                        ...
                        <div style="display: flex; gap: 8px; margin-bottom: 8px;">
                            <span style="background-color: rgba(0, 73, 219, 0.1); color: #0049db; padding: 4px 8px; border-radius: 6px; font-size: 12px; font-weight: 600;">{insight["dataset"]}</span>
                        ...
                        <button style="color: #0049db; font-size: 12px; font-weight: bold; background: none; border: none; cursor: pointer;">View Detailed Analysis →</button>
                    </div>
                </div>
            </div>
            """,
    ...
    with col2:
        ...
        st.markdown(
            """
        <div style="background: linear-gradient(135deg, #0049db 0%, #2962ff 100%); border-radius: 12px; padding: 20px; margin-top: 32px; color: white;">
            <h4 style="font-size: 18px; font-weight: bold; margin-bottom: 8px;">Automate Tasks</h4>
            <p style="font-size: 14px; opacity: 0.8; margin-bottom: 16px;">Let Nexus AI handle routine data cleaning and preparation automatically.</p>
            <button style="width: 100%; padding: 12px; background: white; color: #0049db; border: none; border-radius: 8px; font-weight: bold; cursor: pointer;">Enable Auto-Pilot</button>
        </div>
        """,
            unsafe_allow_html=True,
        )
